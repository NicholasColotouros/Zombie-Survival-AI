...
public class SurvivorAI : MonoBehaviour 
{
	...
	public Transform[] ClockwiseWayPoints;
	public Transform[] CounterClockwiseWayPoints;
	...
	private Transform[] Waypoints; // Ordered set of places to go, which includes the goal at the very end
	...
	void Start () 
	{
		...
		if( blackboard.Direction == Initializer.ZombieMovementDirection.Clockwise)
			Waypoints = CounterClockwiseWayPoints;
		else
			Waypoints = ClockwiseWayPoints;
	}
